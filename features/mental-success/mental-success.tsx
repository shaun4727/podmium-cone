...
export const MentalSuccess = () => {
    ...
    return (
        <div className="md:mt-40 py-8 md:py-0 md:px-16" ref={mentalSuccessRef}>
            <div className="flex justify-center">
                <h1 className="w-200 text-[10vw] md:text-[5vw] font-bold font-roboto uppercase  text-center leading-none">
            ...
            <div className="md:hidden px-4">
                <Image
                    ...
                    className=""
                />
                <div className="flex flex-col gap-6 first-1 my-4">
                    <h4 className="font-bold text-xl border-l-2 border-theme-brandy px-1">01</h4>
                    <h2 className="text-[#2e2b25] text-5xl uppercase font-roboto font-bold">
                        we listen first
                    </h2>
                    <p className="font-2xl font-light font-roboto">
                        Before offering solutions, we take the time to truly understand your unique
                        challenges, goals, and experiences.
                    </p>
                </div>
                <Image
                ...
                />
                <div className="flex flex-col gap-6 first-1 my-4">
                    <h4 className="font-bold text-xl border-l-2 border-theme-brandy px-1">02</h4>
                    <h2 className="text-[#2e2b25] text-5xl uppercase font-roboto font-bold">
                        we listen first
                    </h2>
                    <p className="font-2xl font-light font-roboto">
                ...
                />
                <div className="flex flex-col gap-6 first-1 my-4">
                    <h4 className="font-bold text-xl border-l-2 border-theme-brandy px-1">03</h4>
                    <h2 className="text-[#2e2b25] text-5xl uppercase font-roboto font-bold">
                        we listen first
                    </h2>
                    <p className="font-2xl font-light font-roboto">
                ...
                />
                <div className="flex flex-col gap-6 first-1 my-4">
                    <h4 className="font-bold text-xl border-l-2 border-theme-brandy px-1">04</h4>
                    <h2 className="text-[#2e2b25] text-5xl uppercase font-roboto font-bold">
                        we listen first
                    </h2>
                    <p className="font-2xl font-light font-roboto">
